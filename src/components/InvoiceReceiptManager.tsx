...
export default function InvoiceReceiptManager({
  ...
  const [receiptCompanySub, setReceiptCompanySub] = useState("2 Swed Free Avenue, Sussex • Official Commission Receipt");
  ...
  useEffect(() => {
    if (activeInvoice && !editingSavedInvoiceId) {
      if (invoiceTemplate === 'SWEDS_WOOD') {
        ...
        setInvoiceCompanyContact("2 Swed Free Avenue, Sussex");
        setInvoiceTerms("");
  ...
  useEffect(() => {
    if (activeReceipt) {
      ...
      setReceiptCompanySub("2 Swed Free Avenue, Sussex • Official Commission Receipt");
